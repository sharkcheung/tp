...
class WorkermanGateway extends Command
{
    protected function configure()
    {
        ...
        $this->setName('gatewayworker')
            ->addArgument('service', Argument::OPTIONAL, 'gatewayworker service: gateway|register|businessworker', null)
            ->addOption('host', 'H', Option::VALUE_OPTIONAL, 'the host of gatewayworker server', null)
            ->addOption('port', 'P', Option::VALUE_OPTIONAL, 'the port of gatewayworker server', null)
            ->addOption('daemon', 'd', Option::VALUE_OPTIONAL, 'Run the gatewayworker server in daemon mode.')
